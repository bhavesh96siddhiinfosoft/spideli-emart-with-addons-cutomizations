...
<script type="text/javascript">
    ...
    $(document).ready(function () {
         ...
         * This list is fetched whole and paged in the browser, so filtering
        ...
        const table = $('#rentalTable').DataTable({
            ...
            ajax: async function (data, callback, settings) {
                ...
                try {
                    ...
                    /* A rental order belongs to the region of the store it was
                     * placed with. Orders taken before the backfill carry no
                     * regionId and are hidden while a region is selected - run
                     * Region Backfill to place them. */
                    const regionRentals = regionDocs(querySnapshot);

                    await Promise.all(regionRentals.map(async (doc) => {
