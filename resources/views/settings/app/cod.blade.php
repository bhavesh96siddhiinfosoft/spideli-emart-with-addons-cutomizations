...
$(document).ready(function () {
    ...
    ref.get().then(async function (snapshots) {
        ...
        await loadRegionAssignment(cod);
    ...
    $(".edit-setting-btn").click(function () {
        ...
        database.collection('settings').doc("CODSettings").update({'isEnabled': isCODEnabled, 'regionIds': getRegionAssignment()}).then(function (result) {
