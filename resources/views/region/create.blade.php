    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">{{ trans('lang.region_create') }}</li>
            </ol>
        </div>
    </div>
                        ...
                        <fieldset>
                            ...
                            <div class="form-group row width-100">
                                <div class="form-check">
                                    <input type="checkbox" class="publish" id="publish" checked>
...
<script type="text/javascript">
    ...
    var regionId = database.collection('tmp').doc().id;
    ...
    $(document).ready(function () {
        ...
        Promise.all([loadCurrencies(), loadZones()]).then(function () {
    ...
    /* Only zones that are not already claimed by another region can be picked,
     * so a zone never belongs to two regions at once. */
